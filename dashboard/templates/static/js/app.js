// este es el archivo valido
// Set up our chart
var svgWidth = 1000;
var svgHeight = 700;
var margin = { top: 30, right: 40, bottom: 120, left: 160 };
...
url = "https://github.com/dbarrantes200/dbarrantes200.github.io/tree/master/datasets/data.csv";
var url = "https://shresthaachyut.github.io/Project2/airbnb2.json"
//url = "/data";
d3.json(url, function (err, data) {
    ...
    var defaultAxisLabelX = "medianIncome"

    // set the default y-axis
    var defaultAxisLabelY = "totalMCI"
    ...
    chart.append("text")
        ...
        // This axis label is active by default
        .attr("class", "axis-text-x inactive")
        .attr("data-axis-name", "premiseType")
        .text("Premise Type");
    ...
    chart.append("text")
        ...
        .attr("class", "axis-text-y inactive")
        .attr("data-axis-name", "breakAndEnter")
        .text("Break and Enter");    
 
    chart.append("text")
        .attr("transform", `translate(-100,${height / 2})rotate(270)`)
        .attr("class", "axis-text-y inactive")
        .attr("data-axis-name", "robbery")
        .text("Robbery");  
        
    chart.append("text")
        .attr("transform", `translate(-120,${height / 2})rotate(270)`)
        .attr("class", "axis-text-y inactive")
        .attr("data-axis-name", "theftOver")
        .text("Theft Over");     

    chart.append("text")
        .attr("transform", `translate(-140,${height / 2})rotate(270)`)
        .attr("class", "axis-text-y inactive")
        .attr("data-axis-name", "autoTheft")
        .text("Auto Theft"); 
